...
function getData(){
   ...
   /* function setList(csvData2){
        ...
        var players = list.selectAll("player")
            .data(csvData2)
            .enter().append("text")
            .attr("x", function(d,i){return 100 * (i % 1)})
            .attr("y", function(d,i){return 20 * ( Math.floor(i) ) })
            .attr("fill", "#000")
    ...
    */
    ...
    function changeAttribute2(attribute2){
        ...
        filterPlayersByState(csvData2);
    };

    function thirdDropdown(filteredPlayers) {
        
        var thirdDrop = d3.select("body")
            .append("select")
...
names = d3.select(".listName")
            .data(singlePlayer)
            .attr("x", 5)
            .attr("y", 25)
            .attr("fill", "#000")
            .text(function(d){return "Name: " + d.NAMES});
        
        positions = d3.select(".listPos")
            .data(singlePlayer)
            .attr("x", 5)
            .attr("y", 75)
            .attr("fill", "#000")
